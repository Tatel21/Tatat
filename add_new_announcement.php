...
<form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
       <fieldset> 
                           <div id="legend">
                                <legend class="">New Announcement</legend>
                            </div> 
       </fieldset>    

 <input type="hidden" id="inputEmail3" name="id" value="<?php
    $id = mysql_query("select MAX(announcementID) as max_announcementID from tb_announcement");                                       
      $row = mysql_fetch_array($id);
       echo $row['max_announcementID'] + 1;                                       
...
?> 
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="location"   class="form-control" id="password" required/>
    </div>
  </div>
    ...
    <div class="col-sm-10">
      <textarea name="details" style="resize:none;" class="form-control"></textarea>
    </div>
  </div> 
